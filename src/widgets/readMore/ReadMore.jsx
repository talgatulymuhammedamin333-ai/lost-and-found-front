  ...
  return (
    <div className="flex justify-center py-10 px-4min-h-screen">
      <div className="bg-white shadow-xl rounded-3xl w-full max-w-4xl overflow-hidden">
        ...
        <img src={`http://localhost:3000/uploads/${post.image_url}`} alt={post.title} className="w-full h-96 object-cover" />
        ...
        <div className="p-8">
          ...
          <div className="flex items-center gap-4 border-b pb-6 mb-8"> <img src={`http://localhost:3000/uploads/${post.profileimg}`} alt="" className="w-16 h-16 rounded-full object-cover border"/> <div>
